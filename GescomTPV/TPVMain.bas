...
Public Sub LoadImages(BarraHerramientas As Toolbar)
    ...
    With BarraHerramientas
        .ImageList = TPVMain.mglIconosPequeños
        Set objButton = .Buttons.Add(, "Nuevo", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Nuevo").Key)
        objButton.ToolTipText = "Crear un nuevo objeto"
        Set objButton = .Buttons.Add(, "Abrir", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Abrir").Key)
        objButton.ToolTipText = "Editar"
        Set objButton = .Buttons.Add(, "Imprimir", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Imprimir").Key)
        objButton.ToolTipText = "Imprimir"
        Set objButton = .Buttons.Add(, , , tbrSeparator)
        Set objButton = .Buttons.Add(, "Eliminar", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Eliminar").Key)
        objButton.ToolTipText = "Borrar"
        Set objButton = .Buttons.Add(, "Actualizar", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Actualizar").Key)
        objButton.ToolTipText = "Refrescar la vista de objetos"
        Set objButton = .Buttons.Add(, "Buscar", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Buscar").Key)
        objButton.ToolTipText = "Consultas"
        Set objButton = .Buttons.Add(, , , tbrSeparator)
        'Set objButton = .Buttons.Add(, "IconosGrandes", , tbrButtonGroup, TPVMain.mglIconosPequeños.ListImages("IconosGrandes").Key)
        'objButton.ToolTipText = "Iconos Grandes"
        Set objButton = .Buttons.Add(, "IconosPequeños", , tbrButtonGroup, TPVMain.mglIconosPequeños.ListImages("IconosPequeños").Key)
        objButton.ToolTipText = "Iconos pequeños"
        'Set objButton = .Buttons.Add(, "Lista", , tbrButtonGroup, TPVMain.mglIconosPequeños.ListImages("Lista").Key)
        'objButton.ToolTipText = "Lista de iconos"
        Set objButton = .Buttons.Add(, "Detalle", , tbrButtonGroup, TPVMain.mglIconosPequeños.ListImages("Detalle").Key)
        objButton.ToolTipText = "Detalle"
        objButton.Value = tbrPressed
        Set objButton = .Buttons.Add(, , , tbrSeparator)
        Set objButton = .Buttons.Add(, "QuickSearch", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Buscar").Key)
        objButton.ToolTipText = "Búsqueda rápida"
        Set objButton = .Buttons.Add(, "GroupBy", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("GroupBy").Key)
        objButton.ToolTipText = "Agrupar"
        Set objButton = .Buttons.Add(, "ShowFields", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Propiedades").Key)
        objButton.ToolTipText = "Lista de campos"
        Set objButton = .Buttons.Add(, "Sort", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Ordenar").Key)
        objButton.ToolTipText = "Ordenar los campos"
                
        Set objButton = .Buttons.Add(, , , tbrSeparator)
        Set objButton = .Buttons.Add(, "ExportToExcel", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Excel").Key)
        objButton.ToolTipText = "Exportar a Excel"
        
        Set objButton = .Buttons.Add(, , , tbrSeparator)
        Set objButton = .Buttons.Add(, "Cerrar", , tbrDefault, TPVMain.mglIconosPequeños.ListImages("Cerrar").Key)
