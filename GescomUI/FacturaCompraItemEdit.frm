...
Begin VB.Form FacturaCompraItemEdit 
   ...
   Caption         =   "Línea de la Factura de Compra"
   ClientHeight    =   3255
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5655
   ...
   Begin VB.CheckBox chkHayAlbaran 
      Caption         =   "Esta línea está relacionada con un albarán"
      Enabled         =   0   'False
      Height          =   255
      Left            =   240
      TabIndex        =   10
...
Private Sub Form_Load()
    ...
    With mobjFacturaCompraItem
        ...
        If .IsNew Then
            Caption = "Línea de la Factura de Compra [(nueva)]"

        Else
            Caption = "Línea de la Factura de Compra [" & .Material & "]"
