...
Begin VB.Form AlbaranCompraArticuloEdit 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Línea de albarán de compra"
   ClientHeight    =   3435
   ClientLeft      =   2970
   ClientTop       =   2895
   ClientWidth     =   9735
   ...
   EndProperty
   Icon            =   "AlbaranCompraArticuloEdit.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3435
   ...
   Begin VB.Frame Frame2 
      Caption         =   "Datos de la línea de albarán de compra"
      Height          =   2775
      Left            =   120
      TabIndex        =   0
      Top             =   120
   ...
   End
End
Attribute VB_Name = "AlbaranCompraArticuloEdit"
...
Private WithEvents mobjAlbaranCompraItemArticulo As AlbaranCompraItemArticulo
Attribute mobjAlbaranCompraItemArticulo.VB_VarHelpID = -1
...
Private Sub txtDescuento_Change()
    ...
    If Not mflgLoading Then
        TextChange txtDescuento, mobjAlbaranCompraItemArticulo, "Descuento"
        txtBruto = mobjAlbaranCompraItemArticulo.Bruto
    End If
...
Private Sub txtDescuento_LostFocus()
    ...
    txtDescuento = TextLostFocus(txtDescuento, mobjAlbaranCompraItemArticulo, "Descuento")

End Sub

Public Sub Component(AlbaranCompraItemArticuloObject As AlbaranCompraItemArticulo, lngProveedorID As Long)

    Set mobjAlbaranCompraItemArticulo = AlbaranCompraItemArticuloObject
...
Private Sub cmdApply_Click()
    ...
    mobjAlbaranCompraItemArticulo.ApplyEdit
    mobjAlbaranCompraItemArticulo.BeginEdit
    Exit Sub
...
Private Sub cmdCancel_Click()
    ...
    mobjAlbaranCompraItemArticulo.CancelEdit
    Unload Me
...
Private Sub Form_Load()
    ...
    mflgLoading = True
    With mobjAlbaranCompraItemArticulo
        EnableOK .IsValid
        
        If .IsNew Then
          Caption = "Línea del albarán de compra [(nuevo)]"
        
        Else
          Caption = "Línea del albarán de compra [" & .ArticuloColor & "]"
...
Private Sub mobjAlbaranCompraItemArticulo_Valid(IsValid As Boolean)
...
Private Sub txtCantidadT36_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT36, mobjAlbaranCompraItemArticulo, "CantidadT36"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT36_LostFocus()
  ...
  txtCantidadT36 = TextLostFocus(txtCantidadT36, mobjAlbaranCompraItemArticulo, "CantidadT36")
...
Private Sub txtCantidadT38_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT38, mobjAlbaranCompraItemArticulo, "CantidadT38"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT38_LostFocus()
  ...
  txtCantidadT38 = TextLostFocus(txtCantidadT38, mobjAlbaranCompraItemArticulo, "CantidadT38")
...
Private Sub txtCantidadT40_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT40, mobjAlbaranCompraItemArticulo, "CantidadT40"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT40_LostFocus()
  ...
  txtCantidadT40 = TextLostFocus(txtCantidadT40, mobjAlbaranCompraItemArticulo, "CantidadT40")
...
Private Sub txtCantidadT42_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT42, mobjAlbaranCompraItemArticulo, "CantidadT42"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT42_LostFocus()
  ...
  txtCantidadT42 = TextLostFocus(txtCantidadT42, mobjAlbaranCompraItemArticulo, "CantidadT42")
...
Private Sub txtCantidadT44_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT44, mobjAlbaranCompraItemArticulo, "CantidadT44"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT44_LostFocus()
  ...
  txtCantidadT44 = TextLostFocus(txtCantidadT44, mobjAlbaranCompraItemArticulo, "CantidadT44")
...
Private Sub txtCantidadT46_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT46, mobjAlbaranCompraItemArticulo, "CantidadT46"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT46_LostFocus()
  ...
  txtCantidadT46 = TextLostFocus(txtCantidadT46, mobjAlbaranCompraItemArticulo, "CantidadT46")
...
Private Sub txtCantidadT48_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT48, mobjAlbaranCompraItemArticulo, "CantidadT48"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT48_LostFocus()
  ...
  txtCantidadT48 = TextLostFocus(txtCantidadT48, mobjAlbaranCompraItemArticulo, "CantidadT48")
...
Private Sub txtCantidadT50_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT50, mobjAlbaranCompraItemArticulo, "CantidadT50"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT50_LostFocus()
  ...
  txtCantidadT50 = TextLostFocus(txtCantidadT50, mobjAlbaranCompraItemArticulo, "CantidadT50")
...
Private Sub txtCantidadT52_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT52, mobjAlbaranCompraItemArticulo, "CantidadT52"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT52_LostFocus()
  ...
  txtCantidadT52 = TextLostFocus(txtCantidadT52, mobjAlbaranCompraItemArticulo, "CantidadT52")
...
Private Sub txtCantidadT54_Change()
  ...
  If Not mflgLoading Then
    TextChange txtCantidadT54, mobjAlbaranCompraItemArticulo, "CantidadT54"
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
  End If
...
Private Sub txtCantidadT54_LostFocus()
  ...
  txtCantidadT54 = TextLostFocus(txtCantidadT54, mobjAlbaranCompraItemArticulo, "CantidadT54")
...
Private Sub txtCantidadT56_Change()
    ...
    If Not mflgLoading Then
        TextChange txtCantidadT56, mobjAlbaranCompraItemArticulo, "CantidadT56"
        txtBruto = mobjAlbaranCompraItemArticulo.Bruto
    End If
...
Private Sub txtCantidadT56_LostFocus()
    ...
    txtCantidadT56 = TextLostFocus(txtCantidadT56, mobjAlbaranCompraItemArticulo, "CantidadT56")
...
'    If ValidarCodigoArticulo(GescomMain.objParametro.Moneda, _
'                          Trim(txtCodigoArticuloColor), _
'                          GescomMain.objParametro.TemporadaActualID) Then
    ...
    If EsFormatoArticuloProveedor(txtCodigoArticuloColor.Text) Then
        ...
        If Not objArticulo Is Nothing Then
            ...
            mobjAlbaranCompraItemArticulo.CodigoArticuloColor = txtCodigoArticuloColor.Text
        End If
    ...
    ElseIf ValidarCodigoArticulo(Trim(txtCodigoArticuloColor), _
        ...
        mobjAlbaranCompraItemArticulo.CodigoArticuloColor = strCodigoArticuloColor
    End If
    txtPrecioCompra.Text = mobjAlbaranCompraItemArticulo.PrecioCompra
    txtBruto = mobjAlbaranCompraItemArticulo.Bruto
    txtArticuloColor = mobjAlbaranCompraItemArticulo.Descripcion
    txtDescripcion = mobjAlbaranCompraItemArticulo.Descripcion
...
Private Sub txtDescripcion_Change()
  ...
  If Not mflgLoading Then _
    TextChange txtDescripcion, mobjAlbaranCompraItemArticulo, "Descripcion"

End Sub
Private Sub txtDescripcion_LostFocus()

  txtDescripcion = TextLostFocus(txtDescripcion, mobjAlbaranCompraItemArticulo, "Descripcion")
...
Private Sub txtPrecioCompra_Change()
    ...
    If Not mflgLoading Then
        TextChange txtPrecioCompra, mobjAlbaranCompraItemArticulo, "PrecioCompra"
        txtBruto = mobjAlbaranCompraItemArticulo.Bruto
    End If
...
Private Sub txtPrecioCompra_LostFocus()
  ...
  txtPrecioCompra = TextLostFocus(txtPrecioCompra, mobjAlbaranCompraItemArticulo, "PrecioCompra")
...
Private Sub txtBruto_Change()
  ...
  If Not mflgLoading Then _
    TextChange txtBruto, mobjAlbaranCompraItemArticulo, "Bruto"

End Sub

Private Sub txtBruto_LostFocus()

  txtBruto = TextLostFocus(txtBruto, mobjAlbaranCompraItemArticulo, "Bruto")
...
Private Sub ActualizarEtiquetasTallas()
    ...
    If mobjAlbaranCompraItemArticulo.ArticuloColorID = 0 Then Exit Sub
    
    If mobjTallaje Is Nothing Then Set mobjTallaje = New Tallaje
    
    If mobjTallaje.TallajeID <> mobjAlbaranCompraItemArticulo.objArticuloColor.objArticulo.TallajeID Then
        Set mobjTallaje = Nothing
        Set mobjTallaje = New Tallaje
        mobjTallaje.Load mobjAlbaranCompraItemArticulo.objArticuloColor.objArticulo.TallajeID
