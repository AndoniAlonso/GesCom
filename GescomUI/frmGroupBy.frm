...
Dim grs As JSGroups
    ...
    For j = 0 To 3
        cboGroups(j).AddItem "(Ninguno)"
    Next
    Set cs = grid.Columns
    For i = 1 To cs.Count
        Set c = cs.Item(i)
        If c.ColumnType <> jgexIcon And c.Visible Then
            For j = 0 To 3
                cboGroups(j).AddItem c.Caption  'c.Tag
