...
Private Sub grPrev_OnPrintClick(ByVal UsePrintSetupDlg As GridEX20.JSRetBoolean)
    'UsePrintSetupDlg.value = Not UsePrintSetupDlg.value
    UsePrintSetupDlg.Value = True
'    If Not UsePrintSetupDlg Then
'        Call grPrev_OnPrintClick(UsePrintSetupDlg)
'        Exit Sub
'    End If
    Unload Me
End Sub
