...
Private Sub RefreshListView()
    ...
    With jgrdItems
        ...
        FormatoJColumn .Columns("Calle"), 4, "Dirección", , ColumnSize(20)
        FormatoJColumn .Columns("Poblacion"), 5, "Población", , ColumnSize(10)
        FormatoJColumn .Columns("Provincia"), 6, "Provincia", , ColumnSize(10)
        FormatoJColumn .Columns("Telefono1"), 7, "Teléfono", , ColumnSize(8)
        ...
        FormatoJColumn .Columns("Codigo"), 13, "Cód.", , ColumnSize(3)
    End With
...
Dim objButton As Button
    ...
    Set objButton = Me.tlbHerramientas.Buttons.Add(, , , tbrSeparator)
    Set objButton = Me.tlbHerramientas.Buttons.Add(, "ExportToCSV", , tbrDefault, GescomMain.mglIconosPequeños.ListImages("Proveedor").Key)
    ...
    jgrdItems.GridImages.Add GescomMain.mglIconosPequeños.ListImages("Proveedor").Picture
